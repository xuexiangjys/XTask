 ...
 */
public abstract class SerialGroupTaskStep extends AbstractTaskStep {

    public SerialGroupTaskStep(ITaskChainEngine engine, ITaskParam taskParam, ITaskStepHandler taskHandler) {
        super(engine, taskParam, taskHandler);
    }

    public SerialGroupTaskStep(ITaskChainEngine engine, ThreadType threadType, ITaskParam taskParam, ITaskStepHandler taskHandler) {
